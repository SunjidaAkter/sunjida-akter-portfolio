...
const ProjectDetail = () => {
    ...
    return (
        <div>
            <div className={scrolled ? 'navbar fixed z-40 bg-base-200  px-12 ' : ' navbar fixed z-40 bg-base-200  px-12 '}>{/*</div><div class="navbar  z-40 bg-base-300  px-12">*/}
                ...
                <div class="navbar-start">
                    ...
                    <div className='flex justify-center items-center'>
                        ...
                        <div>
                            <a href='/' class=" btn btn-ghost normal-case lg:text-5xl hover:bg-base-200 text-3xl font-caveat font-semibold ">Sunjida</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="hero-content flex-col lg:flex-row">
                    <div className='lg:w-[900px] md:w-[600px] w-[390px] lg:flex lg:flex-row flex-col flex lg:justify-between mt-20'>
                        ...
                        <div className='lg:w-1/2 w-full md:w-full lg:mt-0 md:mt-36 mt-36'>
                            ...
                            <p className='pl-10 text-left font-balsamq font-normal italic text-base'>{match.des}</p>
                            <p className='pl-10 text-left mt-3 font-extrabold font-l2 text-2xl'>Features :</p>
                            <ol>
                                <li className='pl-10 text-left font-balsamq font-normal italic text-sm'>•<span className='pl-2'>{match.des1}</span></li>
                                <li className='pl-10 text-left font-balsamq font-normal italic text-sm'>•<span className='pl-2'>{match.des2}</span></li>
                                <li className='pl-10 text-left font-balsamq font-normal italic text-sm'>•<span className='pl-2'>{match.des3}</span></li>
                                <li className='pl-10 text-left font-balsamq font-normal italic text-sm'>•<span className='pl-2'>{match.des4}</span></li>
