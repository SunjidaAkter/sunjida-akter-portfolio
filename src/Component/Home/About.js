        ...
        <div id='about' className='px-12 py-12 bg-white dark:bg-[#22272e] dark:text-white'>
            ...
            <div className='mt-[50px] flex lg:flex-row flex-col justify-between items-start '>
                <div className='lg:w-[48%]  w-full mb-5'>
                    ...
                    <Fade left cascade><p className='font-medium text-black text-left tect-xl lg:mb-0 mb-14 dark:text-white'>-THANKS & REGARDS <br /><span className='font-caveat font-bold text-3xl dark:text-white'>Sunjida Akter <span className='text-xl dark:text-white '>🖤🖤 🤍🤍</span></span></p></Fade>
                </div>
                <div className='lg:w-[48%] w-full mb-5'>
                    ...
                    <div>
                        ...
                        <progress class="progress dark:progress-primary w-full dark:bg-stone-500" value="90" max="100"></progress> <br />
                        ...
                        <progress class="progress dark:progress-primary w-full dark:bg-stone-500 dark:text-" value="80" max="100"></progress><br />
                        ...
                        <progress class="progress dark:progress-primary w-full dark:bg-stone-500" value="70" max="100"></progress><br />
